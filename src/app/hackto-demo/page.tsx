  ...
  <>
    ...
    <div className=" mx-auto   max-w-[1177px] w-[96%] text-[#1D3178] mt-20">
      ...
      <div className="flex items-center justify-between">
        <div className="max-w-[770px] bg-[#F8F8FD] p-5 w-[70%]">
          ...
          <form className=" ">
            <div className="mb-4">
              <input
                ...
                className="w-full p-2 border-b-2 border-gray-[#BFC6E0] rounded mt-1 focus:outline-none"
              />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              <div>
                <input
                  ...
                  className="w-full p-2 border-b-2  border-gray-300 rounded mt-1 focus:outline-none"
                />
              </div>
              <div>
                <input
            ...
            <button className="bg-[#FB2E86] text-white py-2 px-4 rounded hover:bg-gray-400">
              Continue Shopping
            </button>
          </form>
        </div>
        ...
        <div>
          ...
          <div className=" bg-[#F4F4FC] pt-4">
            ...
            <button className="bg-[#19D16F] text-white py-2 px-4 rounded-md hover:bg-pink-700">
              Proceed To Checkout
            </button>
          </div>
        </div>
